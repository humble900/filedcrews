...
async function main() {
  ...
  try {
    ...
    const actionItems = [
      { type: 'overdue_invoice', entity: 'invoices', title: 'Overdue Invoice #INV-2026-004', desc: 'Payment of $4,200.00 from Alpha Builders is 14 days overdue.', sev: 'High' },
      { type: 'unassigned_job', entity: 'jobs', title: 'Unassigned Job Scheduled Tomorrow', desc: 'Emergency Sprinkler Calibration is scheduled for tomorrow but has no crew assigned.', sev: 'Medium' },
      { type: 'unsold_estimate', entity: 'estimates', title: 'Unsold Proposal Expiring Soon', desc: 'Estimate #EST-109 for $12,500.00 expires in 48 hours without approval.', sev: 'Medium' },
      { type: 'custom', entity: 'incident_reports', title: 'Critical Equipment Incident Logged', desc: 'High severity equipment malfunction reported on project site "bodi tomos".', sev: 'High' },
      { type: 'custom', entity: 'geofence_events', title: 'Selfie Match Verification Request', desc: 'Mats Gonj logged a check-in event with borderline face verification confidence.', sev: 'Low' }
    ];
