  ...
  return (
    <PublicPageLayout>
      <SEO
        ...
        description="Request deletion of your Staff Tracker account and associated data."
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="mt-2 text-muted-foreground text-lg">
            You have the right to request deletion of your account and personal data from Staff Tracker.
          </p>
        </div>
