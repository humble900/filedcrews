...
const steps = [
  {
    ...
    description:
      "A company administrator creates an account on the Staff Tracker website. From the dashboard, they register staff members, define geofenced work sites, and configure tracking and verification settings.",
  },
  {
    icon: Smartphone,
    title: "2. Staff Sign In on the Mobile App",
    description:
      "Each staff member receives credentials from their administrator and signs in on the Staff Tracker mobile app installed on their phone.",
  },
  {
    icon: MapPin,
  ...
  return (
    <PublicPageLayout>
      <SEO
        ...
        description="Learn how Staff Tracker connects the mobile app for field staff with the admin dashboard for supervisors."
        path="/about"
      />
      <div className="space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-foreground">How Staff Tracker Works</h1>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Card>
            ...
            <CardContent className="text-foreground/90 text-sm">
              The Staff Tracker mobile app is installed on staff members' phones. Staff sign in with credentials
          ...
          <Card>
            ...
            <CardContent className="text-foreground/90 text-sm">
              The Staff Tracker web dashboard is used by company administrators and supervisors. From the
