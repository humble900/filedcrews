  ...
  return (
    <PublicPageLayout>
      <SEO
        ...
        description="Terms of Service for Live Staff Tracker — mobile app and admin dashboard."
        path="/terms"
      />
      <article className="prose prose-sm sm:prose max-w-none text-foreground prose-headings:text-foreground prose-p:text-foreground/90 prose-li:text-foreground/90 prose-strong:text-foreground prose-a:text-primary">
        ...
        <p>
          These Terms of Service ("Terms") govern your use of the Staff Tracker mobile application and the
          Staff Tracker admin dashboard (collectively, the "Service") provided by Live Staff Tracker ("we",
